...
if __name__ == "__main__":
    ...
    if args.BF == "MVDR":
        data_root_dir = "/n/work3/sekiguch/data_for_paper/IROS2022/WPE_FINETUNED_DNN_MVDR_result/test/"
        save_WER_dir = "/n/work3/sekiguch/data_for_paper/IROS2022/WPE_FINETUNED_DNN_MVDR_result/test/WER/"
        output_csv_fname = "wer_MVDR_WPE_FINETUNED.csv"
    else:
    ...
    for data_parent_dir in glob(f"{data_root_dir}/lstm*"):
        data_dir_list_tmp = sorted(glob(f"{data_parent_dir}/wpe_minute*ratio={tuning_data_ratio}*"))
        data_dir_list_tmp2 = []
    ...
    data_dict = {}
    for wer_fname in glob(f"{save_WER_dir}/*---wpe_minute*.txt"):
        with open(wer_fname, "r") as f:
