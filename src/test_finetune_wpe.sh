# CUDA_VISIBLE_DEVICES=5 ./test_finetune_wpe.py  --idx 0 --BF MVDR &
...
CUDA_VISIBLE_DEVICES=6 ./test_finetune_wpe.py  --idx 6 --BF MVDR &
CUDA_VISIBLE_DEVICES=7 ./test_finetune_wpe.py  --idx 7 --BF MVDR &
