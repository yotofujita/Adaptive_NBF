...
class IterWPEMaskBasedMVDR(BaseModule):
    ...
    def beamform(mix_stft, mask, ref_channel=0, eps=1e-4):
        ...
        R = contract("bkft,blft->bklf", noise_stft, noise_stft.conj())  # [B, M, M, F]
...
if __name__ == "__main__":
    ...
    device = "cuda"
    module = IterWPEMaskBasedMVDR(cfg1).to(device).to(torch.float64)
