...
class FastMNMF(BaseModule):
    ...
    def step(self, batch, ref_signal=None):
        ...
        if ref_signal is None:
            ...
            for mx, d, mc, rs in zip(mix_stft, doa, mic_shape, ref_signal):
                sep_stft.append(self.separate(mx, d, mc, rs))
    ...
    def separate(self, mix_stft, doa, mic_shape, ref_signal=None):
