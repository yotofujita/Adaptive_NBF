...
def main(args):
    ...
    version = f"wpe_incremental-n_epoch={args.reload_epoch_interval}-intv_minute={args.tuning_data_interval_minute}-minute={args.tuning_data_minute}-ratio={args.tuning_data_ratio}-finetune={args.finetune}-batch={args.batch_size}-lr={args.lr}"
