...
def main(args):
    ...
    if (args.BF_input == "DSBF") or (args.use_BF is False):
        version = (
            f"minute={args.tuning_data_minute}-ratio={args.tuning_data_ratio}-finetune={args.finetune}"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--epoch_interval", type=int, default=5, help="The interval between ckpts")
